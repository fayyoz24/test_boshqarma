...
from corecode.models import MonthSession
...
class UserSessionAccess(models.Model):
    """
    Tracks user access to specific sessions.
    """
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='session_accesses')
    session = models.ForeignKey(MonthSession, on_delete=models.CASCADE, related_name='user_accesses')
